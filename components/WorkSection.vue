<template>
  <section id="works">
    ...
    <div v-for="company in workingProjects">
      <div class="company">
        ...
        <div class="company-tags">
          <span v-for="tag in company.techStack" :key="tag" class="tag">
            {{ tag }}
          </span>
        </div>
      </div>
      <div class="work-card-lane">
        <CardsWorkCard v-for="project in company.projects" :key="project.imgSrc" :image="project.image"
          :on-click-function="onClickFunction" :content="project" />
      </div>
    </div>
  </section>
</template>
